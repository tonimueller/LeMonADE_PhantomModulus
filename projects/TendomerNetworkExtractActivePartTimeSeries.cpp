...
#include <LeMonADE_PM/analyzer/AnalyzerWriteBfmFileSubGroupTendomer.h>
...
int main(int argc, char* argv[]){
	try{
        ...
        taskmanager2.addUpdater(  new UpdaterReadBfmFile<Ing>(inputBFM,myIngredients, UpdaterReadBfmFile<Ing>::READ_STEPWISE) );
		taskmanager2.addAnalyzer( new AnalyzerWriteBfmFileSubGroupTendomer<Ing >(outputBFM, myIngredients, 1,activeComponent) ); 
		//initialize and run
